 ...
 *   node supabase/generate-pins.mjs --admin 1234 --store 5678 --bookstall 9010
 *
...
console.log('');
console.log('Run:  supabase functions deploy verify-pin');
console.log('Then: supabase secrets set ADMIN_PIN_HASH=<above> STORE_PIN_HASH=<above> BOOKSTALL_PIN_HASH=<above> JWT_SECRET=<above>');